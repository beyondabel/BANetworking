...
@class BAURLSessionTaskDelegate;
 ...
 */
typedef id (^BAHTTPResponseProcessBlock) (NSURLResponse *response, NSData *data, BAURLSessionTaskDelegate *delegate);

@interface BAURLSessionTaskDelegate : NSObject
