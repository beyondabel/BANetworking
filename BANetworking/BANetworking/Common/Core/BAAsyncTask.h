...
@class BAAsyncTaskResolver;

typedef void (^BAAsyncTaskCompleteBlock) (id result, NSError *error);
typedef void (^BAAsyncTaskSuccessBlock) (id result);
typedef void (^BAAsyncTaskErrorBlock) (NSError *error);
typedef void (^BAAsyncTaskCancelBlock) (void);
typedef void (^BAAsyncTaskThenBlock) (id result, NSError *error);
typedef void (^BAAsyncTaskProgressBlock) (float progress);
typedef BAAsyncTaskCancelBlock (^BAAsyncTaskResolveBlock) (BAAsyncTaskResolver *resolver);

@interface BAAsyncTask : NSObject
 ...
 *  @return The task itself.
 */
- (instancetype)onSuccess:(BAAsyncTaskSuccessBlock)successBlock;
 ...
 *  @return The task itself.
 */
- (instancetype)onError:(BAAsyncTaskErrorBlock)errorBlock;
...
@interface BAAsyncTaskResolver : NSObject
