...
- (BAAsyncTask *)fetchStoredObjectForKey:(NSString *)key {
    return [BAAsyncTask taskForBlock:^BAAsyncTaskCancelBlock(BAAsyncTaskResolver *resolver) {
